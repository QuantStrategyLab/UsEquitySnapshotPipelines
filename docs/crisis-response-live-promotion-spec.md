...
- 用途：本文档围绕 `Crisis Response Notification-Only Spec`，用于理解 `UsEquitySnapshotPipelines` 的配置、运行、部署、研究或验收边界。
- 主要覆盖：`Current Position`、`Candidate Snapshot`、`Phase Ladder`、`Phase 1 Shadow Plugin Requirements`、`Shadow Signal Schema`。
