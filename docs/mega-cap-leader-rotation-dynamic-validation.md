...
- 用途：本文档围绕 `Mega-Cap Leader Rotation Dynamic Universe Validation`，用于理解 `UsEquitySnapshotPipelines` 的配置、运行、部署、研究或验收边界。
- 主要覆盖：`Current Conclusion`、`Validation Setup`、`Lag Validation Result`、`Yearly Stability`、`Expanded Stability Grid`。
