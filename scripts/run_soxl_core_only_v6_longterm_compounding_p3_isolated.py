"""Run the isolated P2 v6 SOXL research candidate without execution authority."""
...
P2_CANDIDATE_ID = "soxl_soxx_core_only_p2_v6_longterm_compounding"
P2_CONFIG_SHA256 = "2b8361c5d2a3bbae850213414e6e7ba1edf8c50ad5a76629a5f3cb25a8c1d19e"


def _core():
    legacy_path = Path(__file__).with_name("run_soxl_core_only_p3_isolated.py")
    spec = importlib.util.spec_from_file_location("qsl_soxl_core_only_p3_v6_runtime_core", legacy_path)
    if spec is None or spec.loader is None:
        raise RuntimeError("isolated SOXL v6 runner unavailable")
