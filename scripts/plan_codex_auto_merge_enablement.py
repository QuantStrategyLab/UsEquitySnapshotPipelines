...
def render_enablement_plan(
    *,
    ...
    return (
        ...
        "2. If branch protection needs a separate human-approved change, use the generated payload only after reviewing the existing settings; "
        "it must not unintentionally overwrite review, restriction, or admin-enforcement settings.\n\n"
        "```bash\n"
        f"{branch_command}\n"
        "```\n\n"
